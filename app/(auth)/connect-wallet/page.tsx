  ...
  if (isInitializing) {
    return (
      <section className='mx-auto flex min-h-[calc(100dvh-64px)] max-w-md items-center justify-center px-4'>
        <p className='text-muted-foreground text-sm'>Initialising wallet extensions…</p>
      </section>
    )
  }
    ...
    <section className='mx-auto flex min-h-[calc(100dvh-64px)] max-w-md flex-col items-center justify-center gap-6 px-4 text-center'>
      <div className='flex flex-col items-center gap-4'>
        ...
        <p className='text-muted-foreground max-w-xs text-sm'>
          To continue, please connect a Polkadot wallet extension, select an account, and choose a
          chain.
        </p>
      </div>
      ...
      <div className='flex w-full items-center justify-center gap-4'>
        <ChainSelect />
        <WalletSelect placeholder='Select Wallet' onAccountSelected={handleAccountSelected} />
      </div>
    </section>
  )
}
