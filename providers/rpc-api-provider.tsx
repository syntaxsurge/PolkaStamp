...
import { getWsProvider, StatusChange, WsJsonRpcProvider } from 'polkadot-api/ws-provider/web'

import { chainConfig, type ChainConfig, type AvailableApis } from '@/papi-config'
