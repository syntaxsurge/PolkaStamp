...
export function MultiViewDialog({ trigger, views, initialView = 0 }: MultiViewDialogProps) {
        ...
        >
          <AnimatePresence custom={direction} mode='wait' initial={false}>
            <motion.div
              ...
              style={{ width: '100%' }}
            >
              <View title={views[currentView].title} description={views[currentView].description}>
