...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<Ib38e3m2bhrav3>, len: number],
  ...
  XcmPaymentApi: {
     ...
     */
    query_xcm_weight: RuntimeDescriptor<[message: PaseoXcmVersionedXcm], Anonymize<Ic0c3req3mlc1l>>
    /**
    ...
    query_weight_to_asset_fee: RuntimeDescriptor<
      [weight: Anonymize<I4q39t5hn830vp>, asset: PaseoXcmVersionedAssetId],
    ...
    query_delivery_fees: RuntimeDescriptor<
      [destination: PaseoXcmVersionedLocation, message: PaseoXcmVersionedXcm],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [origin: Anonymize<I48v5riethqckl>, call: Anonymize<Ib38e3m2bhrav3>],
      Anonymize<I5mpf9ieem1p8b>
    >
    /**
     * Dry run XCM program
     */
    dry_run_xcm: RuntimeDescriptor<
      [origin_location: PaseoXcmVersionedLocation, xcm: PaseoXcmVersionedXcm],
      Anonymize<Iceqok2pmntdsu>
    >
  }
  /**
  ...
  AssetConversionApi: {
    ...
    get_reserves: RuntimeDescriptor<
      [asset1: Anonymize<I4c0s5cioidn76>, asset2: Anonymize<I4c0s5cioidn76>],
      Anonymize<I5vv5n03oo8gas>
    >
  }
}
...
export type Polkadot_asset_hubWhitelistEntry =
  | PalletKey
