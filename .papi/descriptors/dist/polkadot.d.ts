...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<I9slagtkgsv9j0>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [origin: PolkadotRuntimeOriginCaller, call: Anonymize<I9slagtkgsv9j0>],
      Anonymize<If1fmg4i09v1d8>
    >
    /**
     * Dry run XCM program
     */
...
export type PolkadotWhitelistEntry =
  | PalletKey
