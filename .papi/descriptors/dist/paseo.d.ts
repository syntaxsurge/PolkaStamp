...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<If684pu32bptn4>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [origin: PolkadotRuntimeOriginCaller, call: Anonymize<If684pu32bptn4>],
      Anonymize<I2mj15bm0lbuld>
    >
    /**
     * Dry run XCM program
     */
