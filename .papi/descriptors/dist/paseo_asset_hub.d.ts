...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<Ibbsf5u46f61r4>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [origin: Anonymize<I48v5riethqckl>, call: Anonymize<Ibbsf5u46f61r4>],
      Anonymize<Ic4l4p5329mqka>
    >
    /**
     * Dry run XCM program
     */
...
export type Paseo_asset_hubWhitelistEntry =
  | PalletKey
